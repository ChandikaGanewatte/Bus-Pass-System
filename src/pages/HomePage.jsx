    ...
    return (
        <div className='home-page-content'>
            ...
            <div className='home-page-body'>
                ...
                <div className="home-page-section-2" style={{ padding: "60px 20px", backgroundColor: "#f5f5f5" }}>
                    ...
                    <div className='cards-container'>
                        ...
                        <Card sx={{ width: "100%" }}>
                            ...
                            <CardActions>
                                <Button size="small" variant="contained" color="secondary" onClick={() => navigate("/bus_passes/apply_pass_uni_students")}>
                                    Apply Now
                                </Button>
                            </CardActions>
                        </Card>
                        ...
                        <Card sx={{ width: "100%" }}>
                            ...
                            <CardActions>
                                <Button size="small" variant="contained" color="secondary" onClick={() => navigate("/bus_passes/apply_pass_adults")}>
                                    Apply Now
                                </Button>
                            </CardActions>
                        </Card>
