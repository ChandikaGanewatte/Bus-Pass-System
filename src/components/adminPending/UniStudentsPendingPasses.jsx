...
import { getUniStudentPendingApplications } from "../../services/firebasePassService";

const UniStudentsPendingPasses = () => {
  ...
  useEffect(() => {
    const fetchPasses = async () => {
      const pendingApps = await getUniStudentPendingApplications();
...
export default UniStudentsPendingPasses;
