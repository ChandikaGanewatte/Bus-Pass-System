...
import { getAdultApprovedApplications } from "../../services/firebasePassService";

const AdultIssuedPasses = () => {
 const [pendingPasses, setPendingPasses] = useState([]);
  ...
  useEffect(() => {
    const fetchPasses = async () => {
      const pendingApps = await getAdultApprovedApplications();
...
export default AdultIssuedPasses