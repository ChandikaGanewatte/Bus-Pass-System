...
import { getUniStudentApprovedApplications } from "../../services/firebasePassService";

const UniStudentsIssuedPasses = () => {
  const [pendingPasses, setPendingPasses] = useState([]);
    ...
    useEffect(() => {
      const fetchPasses = async () => {
        const pendingApps = await getUniStudentApprovedApplications();
...
export default UniStudentsIssuedPasses