...
import { getAdultsPendingApplications } from "../../services/firebasePassService";

const AdultsPendingPasses = () => {
 const [pendingPasses, setPendingPasses] = useState([]);
  ...
  useEffect(() => {
    const fetchPasses = async () => {
      const pendingApps = await getAdultsPendingApplications();
...
export default AdultsPendingPasses